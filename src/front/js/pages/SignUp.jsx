  ...
  return (
      ...
      <div className="container-fluid">
          <div className="row">
              ...
              <div
                  className="col-md-6 d-flex flex-column justify-content-center align-items-center text-white p-5 rounded text-center"
                  style={{
              ...
              <div className="col-md-6 d-flex flex-column justify-content-center align-items-center">
                  ...
                  <div id="carouselExample" className="carousel slide mb-4 w-100" style={{ maxWidth: "400px" }}>
                      <div className="carousel-inner text-center">
                          ...
                          <div className="carousel-item active">
                              <img
                                  src="https://i.imgur.com/9V0Bs4W.png"
                  ...
                  <div className="card p-4 shadow-lg" style={{ maxWidth: "350px", width: "100%" }}>
                      <h4 className="mb-3 g-3">Let's get you set up</h4>
                      <form className="row g-3">
                          ...
                          <div className="col-md-12">
                              ...
                              <input
                                  type="text"
                                  className="form-control"
                                  placeholder="Comercio Street, number 2"
                                  required
                              />
                          </div>
