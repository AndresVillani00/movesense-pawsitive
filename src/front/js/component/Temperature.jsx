...
export const Temperature = () => {
    ...
    return (
        <section className="col-md-12 p-5">
            <h3>Historico de Temperatura</h3>
            <br></br>
                        ...
                        <div className="container modal-content">
                            <div className="modal-header row">
                                <div className="d-flex justify-content-between">
                                    <h1 className="modal-title fs-4 col-md-8">Registrar Temperatura</h1>
                                    <button type="button" className="btn-close col-md-4" data-bs-dismiss="modal" aria-label="Close" onClick={() => handleCancel()}></button>
                                </div>
                                <p className="col-md-12">Introduce los detalles de la Temperatura de tu mascota.</p>
                                <Alert />
                            </div>
                            <div className="modal-body">
                                <form onSubmit={handleSubmit} className="row g-3">
                                    <div className="col-md-6 mb-3">
                                        <label className="form-label fw-semibold">Temperatura</label>
                ...
                <div className="card p-4">
                    <ResponsiveContainer width="100%" height={200}>
                        <LineChart data={filteredData}>
                            ...
                            <YAxis unit="ºC" domain={['auto', 'auto']} ticks={ticks} tickFormatter={(v) => `${v}`} />
                            <Tooltip formatter={(v) => `${v} ºC`} />
                            <Line
                                type="monotone"
                ...
                <table className="table table-striped" >
                    <thead style={{ color: "secondary" }}>
                        <tr className="text-center">
                            ...
                            <th scope="col-md-2">Temperatura</th>
                            <th scope="col-md-2">Descripción</th>
                        </tr>
                    </thead>
                    <tbody>
                        {metricasTemperature.map((item, index) => (
