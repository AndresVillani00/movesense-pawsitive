...
export const ReportButton = () => {
  ...
  const generateAIReport = async () => {
    ...
    const prompt = "Actua como un experto veterinario, Interpreta, analiza y realiza un reporte sobre si es bueno o malo cada uno de los datos del json creado sobre mi mascota, devuelveme un json igual pero con los reportes para cada parte, agregando el de accion y el de acciones a futuro, limita el reporte a 1.900 caracterespara evitar timeouts, no pases el limite de caracteres. ";
