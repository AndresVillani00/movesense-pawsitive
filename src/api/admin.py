...
from .models import db, Users, Mascotas, Veterinarios, Metrica, DetailsMetrica, MetricasAsincronas, TipoMetrica, Comida, Incidencias, Sensor
...
def setup_admin(app):
    ...
    admin.add_view(ModelView(DetailsMetrica, db.session)) 
    admin.add_view(ModelView(MetricasAsincronas, db.session)) 
