...
class Producto(db.Model):
    ...
    category = db.Column(db.Enum(), unique=False, nullable=False)  # ARREGLAR, QUE CATEGORIAS PONER? 
    vendedor_id = db.Column(db.Integer, db.ForeignKey('vendedor.id'))
    vendedor_to = db.relationship('Vendedor', foreign_keys=[vendedor_id], backref=db.backref('vendedor_to'), lazy='select')
...
class Orders(db.Model):
    ...
    estado = db.Column(db.Enum('pendiente', 'completado', 'cancelado', name='estado_enum'), nullable=False)    
    fecha_Compra = db.Column(db.DateTime(), unique=False, nullable=False)
...
class Order_Item(db.Model):
    ...
    fecha_Llegada = db.Column(db.DateTime(), unique=False, nullable=True)
...
class Vendedor(db.Model):
    ...
    ingresos_totales = db.Column(db.Integer(), unique=False, nullable=False)
