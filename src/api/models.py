...
class Mascotas(db.Model):
    ...
    foto_mascot = db.Column(db.Text(), unique=False, nullable=True)
...
class Incidencias(db.Model):
    ...
    foto_incidencia = db.Column(db.Text(), unique=False, nullable=True)
...
class Analysis(db.Model):
    ...
    foto_analysis = db.Column(db.Text(), unique=False, nullable=True)
...
class Comida(db.Model):
    ...
    foto_food = db.Column(db.Text(), unique=False, nullable=True)
    ts_init = db.Column(db.DateTime(), unique=False, nullable=True, default=datetime.utcnow)
