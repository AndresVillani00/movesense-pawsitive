...
Revision ID: 180be8aad2da
Revises: f53e537a217d
Create Date: 2025-02-19 06:06:28.494586
...
revision = '180be8aad2da'
down_revision = 'f53e537a217d'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('estado', sa.Enum('pendiente', 'completado', 'cancelado', name='estado_enum'), nullable=False),
